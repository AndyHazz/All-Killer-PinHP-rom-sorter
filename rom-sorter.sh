...
echo "01/14 - Getting ready - moving everything back to main dir from any existing folders ..."
...
echo "02/14 - Moving BIOS files aside"
...
echo "04/14 - Finding the best vertical classics"
...
# mv chinagat.zip "Platformers" Corrupt gfx, unplayable in advmame
...
# mv keith.zip "Platformers" Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=keith
...
# mv wbmlvc.zip "Platformers" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=wbmlvc
...
# mv aoh.zip "Beat 'em ups" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=aoh
...
# mv bigfight.zip "Beat 'em ups" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=bigfight
...
# mv crimfght2.zip "Beat 'em ups" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=crimfght2
...
# mv legendoh.zip "Beat 'em ups" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=legendoh
...
mv simpsn2p.zip "Beat 'em ups"
mv spidman.zip "Beat 'em ups"
mv splatter.zip "Beat 'em ups"
# mv theroes.zip "Beat 'em ups" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=theroes
mv tmht2p.zip "Beat 'em ups"
mv tmnt22p.zip "Beat 'em ups"
mv uccops.zip "Beat 'em ups"
mv vamphalf.zip "Beat 'em ups"
mv vendetta.zip "Beat 'em ups"
mv vendet2p.zip "Beat 'em ups"
...
# mv moomesa.zip "Run and gun" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=moomesa
...
# mv msgogo.zip "Puzzle" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=msgogo
# mv mushitam.zip "Puzzle" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=mushitam
...
# mv puzzli2s.zip "Puzzle" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=puzzli2s
mv puzzloop.zip "Puzzle"
# mv pzloop2.zip "Puzzle" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=pzloop2
mv qix.zip "Puzzle"
...
# mv tgm2.zip "Puzzle" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=tgm2
...
# mv archrivlb.zip "Sports" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=archrivlb
mv bangbead.zip "Sports"
mv blitz.zip "Sports"
mv bssoccer.zip "Sports"
mv bstars2.zip "Sports"
# mv carket.zip "Sports" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=carket
mv cbaj.zip "Sports"
...
# mv punkshot2.zip "Sports" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=punkshot2
...
# mv stonebal2.zip "Sports" # Not supported: http://adb.arcadeitalia.net/dettaglio_mame.php?game_name=stonebal2
mv tbowl.zip "Sports"
...
echo "11/14 - Finding the best horizontal shmups"
...
echo "12/14 - Finding the best Vs fighting games"
...
# mv kinst2.zip "Vs Fighting" # Sorry, that's not going to run on your pi
