...
mv jungler.zip 'Classics'      # Jungler
...
mv benberob.zip 'Platformers'  # Ben Bero Beh (Japan)
...
mv pang.zip 'Platformers'      # Pang (World)
mv penbros.zip 'Platformers'   # Penguin Brothers (Japan)
mv pigout.zip 'Platformers'    # Pigout
mv rainbow.zip 'Platformers'   # Rainbow Islands (new version)
...
mv 3wonders.zip 'Puzzle'       # Three Wonders (World 910520)
...
mv balcube.zip 'Puzzle'        # Bal Cube
...
mv ramprt2p.zip 'Puzzle'       # Rampart (Joystick)
...
mv fantzone.zip 'Shoot em ups' # Fantasy Zone (set 2, unprotected)
...
mv smashtv.zip 'Shoot em ups'  # Smash T.V. (rev 8.00)
...
mv bbmanw.zip 'Sports'         # Bomber Man World / New Dyna Blaster - Global Quest
...
mv offroadt.zip 'Sports'       # Ironman Stewart's Super Off-Road Track Pack
...
mv cybotsu.zip 'Vs Fighting'   # Cyberbots: Fullmetal Madness (US 950424)
